...
module EfxSapphireSoc (
  ...
  assign when_PlicGateway_l21_2 = (! system_spi_1_io_interrupt_plic_gateway_waitCompletion);
  ...
  always @(*) begin
    ...
    case(system_plic_logic_bmb_cmd_payload_fragment_address)
      ...
      22'h002000 : begin
        ...
        system_plic_logic_bus_rsp_payload_fragment_data[5 : 5] = system_cores_0_externalInterrupt_plic_target_ie_2;
  ...
  assign system_cores_0_externalInterrupt_plic_target_requests_3_valid = (system_spi_1_io_interrupt_plic_gateway_ip && system_cores_0_externalInterrupt_plic_target_ie_2);
      ...
      case(system_plic_logic_bmb_cmd_payload_fragment_address)
        ...
        22'h002000 : begin
          if(system_plic_logic_bus_doWrite) begin
            ...
            _zz_system_cores_0_externalInterrupt_plic_target_ie_2 <= system_plic_logic_bmb_cmd_payload_fragment_data[5];
...
module BmbUartCtrl (
  ...
  always @(posedge io_systemClk) begin
    if(systemCd_logic_outputReset) begin
      ...
      bridge_uartConfigReg_clockDivider <= 20'h00050;
