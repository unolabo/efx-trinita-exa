...
wire		system_spi_1_io_data_0;
wire		system_spi_1_io_data_1;
wire  [15:0]	system_gpio_0_io;
wire		system_i2c_1_io_sda;
wire		system_i2c_1_io_scl;
...
.system_i2c_1_io_sda(system_i2c_1_io_sda),
.system_i2c_1_io_scl(system_i2c_1_io_scl),
...
.system_spi_1_io_data_0(system_spi_1_io_data_0),
.system_spi_1_io_data_1(system_spi_1_io_data_1),
...
inout		system_i2c_1_io_sda,
inout		system_i2c_1_io_scl,
...
wire		system_i2c_1_io_sda_writeEnable;
wire		system_i2c_1_io_sda_write;
wire		system_i2c_1_io_sda_read;
wire		system_i2c_1_io_scl_writeEnable;
...
io_sim  #(.WIDTH(2),.REG(0)) i2c1_io_data ( 
.clk(io_systemClk),
.out_pad({system_i2c_1_io_sda_write,system_i2c_1_io_scl_write}),
.out_oe({system_i2c_1_io_sda_writeEnable,system_i2c_1_io_scl_writeEnable}),
.in_pad({system_i2c_1_io_sda_read,system_i2c_1_io_scl_read}),
.io({system_i2c_1_io_sda,system_i2c_1_io_scl}));

io_sim  #(.WIDTH(1+1),.REG(1)) spi1_io_aux (
.clk(io_systemClk),
.out_pad({spi_1_io_sclk_write,spi_1_io_ss}),
.out_oe({1+1{1'b1}}),
.in_pad(),
.io({system_spi_1_io_sclk_write,system_spi_1_io_ss}));

io_sim  #(.WIDTH(2),.REG(1)) spi1_io_data ( 
.clk(io_systemClk),
.out_pad({spi_1_io_data_0_write,spi_1_io_data_1_write}),
.out_oe({spi_1_io_data_0_writeEnable,spi_1_io_data_1_writeEnable}),
.in_pad({system_spi_1_io_data_0_read,system_spi_1_io_data_1_read}),
.io({system_spi_1_io_data_0,system_spi_1_io_data_1}));
