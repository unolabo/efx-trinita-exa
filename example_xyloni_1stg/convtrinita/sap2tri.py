...
def ConvSap2Tri(sap_source):
    shutil.copyfile(sap_source, sap_source+".bk")
    f = open (sap_source+".bk", "r", encoding="utf-8")
    f_new = open(sap_source, "w", encoding="utf-8")
