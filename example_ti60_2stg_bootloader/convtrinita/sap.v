...
`define TRINITA
`define IP_UUID _282a1ee37774475cadffc44729387afc
...
// Component : EfxSapphireSoc_282a1ee37774475cadffc44729387afc

`timescale 1ns/1ps

module EfxSapphireSoc_282a1ee37774475cadffc44729387afc (
  input               io_systemClk,
  input               io_systemClk2,
  input               io_asyncReset,
  input               jtagCtrl_tck,
  ...
  BufferCC_6_282a1ee37774475cadffc44729387afc bufferCC_9 (
    .io_dataIn     (1'b0                 ), //i
    .io_dataOut    (bufferCC_9_io_dataOut), //o
    .io_systemClk  (io_systemClk         ), //i
    .io_asyncReset (io_asyncReset        )  //i
  );
  BufferCC_7_282a1ee37774475cadffc44729387afc bufferCC_10 (
    .io_dataIn                 (1'b0                     ), //i
...
`ifndef TRINITA
  VexRiscv_282a1ee37774475cadffc44729387afc system_cores_0_logic_cpu (
...
`endif
  ...
  JtagBridgeNoTap_282a1ee37774475cadffc44729387afc system_hardJtag_debug_logic_jtagBridge (
  ...
  SystemDebugger_282a1ee37774475cadffc44729387afc system_hardJtag_debug_logic_debugger (
  ...
  BufferCC_8_282a1ee37774475cadffc44729387afc bufferCC_11 (
    .io_dataIn                 (1'b0                     ), //i
    .io_dataOut                (bufferCC_11_io_dataOut   ), //o
    .io_systemClk              (io_systemClk             ), //i
    .system_cores_0_debugReset (system_cores_0_debugReset)  //i
  );
  BmbArbiter_282a1ee37774475cadffc44729387afc system_bridge_bmb_arbiter (
  ...
  BmbDecoder_282a1ee37774475cadffc44729387afc system_cores_0_iBus_decoder (
  ...
  BmbDecoder_1_282a1ee37774475cadffc44729387afc system_bridge_bmb_decoder (
  ...
  BmbDecoder_2_282a1ee37774475cadffc44729387afc bmbDecoder_4 (
...
`ifndef TRINITA
  BmbOnChipRam_282a1ee37774475cadffc44729387afc system_ramA_logic (
    .io_bus_cmd_valid                    (system_ramA_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_cmd_valid                         ), //i
    .io_bus_cmd_ready                    (system_ramA_logic_io_bus_cmd_ready                                                        ), //o
    .io_bus_cmd_payload_last             (system_ramA_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_cmd_payload_last                  ), //i
    .io_bus_cmd_payload_fragment_source  (system_ramA_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_cmd_payload_fragment_source       ), //i
...
`endif
  BmbDecoder_3_282a1ee37774475cadffc44729387afc system_bmbPeripheral_bmb_decoder (
  ...
  BmbClint_282a1ee37774475cadffc44729387afc system_clint_logic (
  ...
  BmbUartCtrl_282a1ee37774475cadffc44729387afc system_uart_0_io_logic (
  ...
  BmbSpiXdrMasterCtrl_282a1ee37774475cadffc44729387afc system_spi_0_io_logic (
  ...
  BmbSpiXdrMasterCtrl_282a1ee37774475cadffc44729387afc system_spi_1_io_logic (
  ...
  BmbI2cCtrl_282a1ee37774475cadffc44729387afc system_i2c_0_io_logic (
  ...
  BmbI2cCtrl_1_282a1ee37774475cadffc44729387afc system_i2c_1_io_logic (
  ...
  EfxTimerCtrl_282a1ee37774475cadffc44729387afc system_userTimer_0_logic (
  ...
  BmbGpio2_282a1ee37774475cadffc44729387afc system_gpio_0_io_logic (
  ...
  BmbToApb3Bridge_282a1ee37774475cadffc44729387afc io_apbSlave_0_logic (
...
module BmbToApb3Bridge_282a1ee37774475cadffc44729387afc (
...
module BmbGpio2_282a1ee37774475cadffc44729387afc (
...
module EfxTimerCtrl_282a1ee37774475cadffc44729387afc (
  ...
  Prescaler_282a1ee37774475cadffc44729387afc prescaler_1 (
  ...
  Timer_282a1ee37774475cadffc44729387afc timer_1 (
...
module BmbI2cCtrl_1_282a1ee37774475cadffc44729387afc (
  input               io_ctrl_cmd_valid,
  output              io_ctrl_cmd_ready,
  input               io_ctrl_cmd_payload_last,
  input      [0:0]    io_ctrl_cmd_payload_fragment_source,
  ...
  I2cSlave_282a1ee37774475cadffc44729387afc i2cCtrl (
...
module BmbI2cCtrl_282a1ee37774475cadffc44729387afc (
  input               io_ctrl_cmd_valid,
  output              io_ctrl_cmd_ready,
  input               io_ctrl_cmd_payload_last,
  input      [0:0]    io_ctrl_cmd_payload_fragment_source,
...
//BmbSpiXdrMasterCtrl_282a1ee37774475cadffc44729387afc replaced by BmbSpiXdrMasterCtrl_282a1ee37774475cadffc44729387afc

module BmbSpiXdrMasterCtrl_282a1ee37774475cadffc44729387afc (
  input               io_ctrl_cmd_valid,
  output              io_ctrl_cmd_ready,
  input               io_ctrl_cmd_payload_last,
  input      [0:0]    io_ctrl_cmd_payload_fragment_source,
  ...
  TopLevel_282a1ee37774475cadffc44729387afc ctrl (
  ...
  StreamFifo_2_282a1ee37774475cadffc44729387afc mapping_cmdLogic_streamUnbuffered_queueWithAvailability (
  ...
  StreamFifo_3_282a1ee37774475cadffc44729387afc ctrl_io_rsp_queueWithOccupancy (
...
module BmbUartCtrl_282a1ee37774475cadffc44729387afc (
  input               io_bus_cmd_valid,
  output              io_bus_cmd_ready,
  input               io_bus_cmd_payload_last,
  input      [0:0]    io_bus_cmd_payload_fragment_source,
  ...
  UartCtrl_282a1ee37774475cadffc44729387afc uartCtrl_1 (
  ...
  StreamFifo_282a1ee37774475cadffc44729387afc bridge_write_streamUnbuffered_queueWithOccupancy (
  ...
  StreamFifo_282a1ee37774475cadffc44729387afc uartCtrl_1_io_read_queueWithOccupancy (
...
module BmbClint_282a1ee37774475cadffc44729387afc (
  input               io_bus_cmd_valid,
  output              io_bus_cmd_ready,
  input               io_bus_cmd_payload_last,
  input      [0:0]    io_bus_cmd_payload_fragment_source,
...
module BmbDecoder_3_282a1ee37774475cadffc44729387afc (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_source,
...
module BmbOnChipRam_282a1ee37774475cadffc44729387afc (
  input               io_bus_cmd_valid,
  output              io_bus_cmd_ready,
  input               io_bus_cmd_payload_last,
  input      [0:0]    io_bus_cmd_payload_fragment_source,
...
module BmbDecoder_2_282a1ee37774475cadffc44729387afc (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_opcode,
...
module BmbDecoder_1_282a1ee37774475cadffc44729387afc (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_source,
...
module BmbDecoder_282a1ee37774475cadffc44729387afc (
  input               io_input_cmd_valid,
  output              io_input_cmd_ready,
  input               io_input_cmd_payload_last,
  input      [0:0]    io_input_cmd_payload_fragment_opcode,
...
module BmbArbiter_282a1ee37774475cadffc44729387afc (
  ...
  StreamArbiter_282a1ee37774475cadffc44729387afc memory_arbiter (
...
module BufferCC_8_282a1ee37774475cadffc44729387afc (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
...
module SystemDebugger_282a1ee37774475cadffc44729387afc (
...
module JtagBridgeNoTap_282a1ee37774475cadffc44729387afc (
  input               io_ctrl_tdi,
  ...
  FlowCCByToggle_282a1ee37774475cadffc44729387afc flowCCByToggle_1 (
...
`ifndef TRINITA
module VexRiscv_282a1ee37774475cadffc44729387afc (
  ...
  StreamFifoLowLatency_282a1ee37774475cadffc44729387afc IBusSimplePlugin_rspJoin_rspBuffer_c (
...
module BufferCC_7_282a1ee37774475cadffc44729387afc (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               debugCd_logic_outputReset
...
module BufferCC_6_282a1ee37774475cadffc44729387afc (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               io_asyncReset
...
module Timer_282a1ee37774475cadffc44729387afc (
  input               io_tick,
  input               io_clear,
  input      [11:0]   io_limit,
  output              io_full,
...
module Prescaler_282a1ee37774475cadffc44729387afc (
  input               io_clear,
  input      [7:0]    io_limit,
  output              io_overflow,
  input               io_systemClk,
...
//I2cSlave_282a1ee37774475cadffc44729387afc replaced by I2cSlave_282a1ee37774475cadffc44729387afc

module I2cSlave_282a1ee37774475cadffc44729387afc (
  output              io_i2c_sda_write,
  input               io_i2c_sda_read,
  output              io_i2c_scl_write,
  input               io_i2c_scl_read,
  ...
  BufferCC_2_282a1ee37774475cadffc44729387afc io_i2c_scl_read_buffercc (
    .io_dataIn                  (io_i2c_scl_read                    ), //i
    .io_dataOut                 (io_i2c_scl_read_buffercc_io_dataOut), //o
    .io_systemClk               (io_systemClk                       ), //i
    .systemCd_logic_outputReset (systemCd_logic_outputReset         )  //i
  );
  BufferCC_2_282a1ee37774475cadffc44729387afc io_i2c_sda_read_buffercc (
...
//StreamFifo_3_282a1ee37774475cadffc44729387afc replaced by StreamFifo_3_282a1ee37774475cadffc44729387afc

//StreamFifo_2_282a1ee37774475cadffc44729387afc replaced by StreamFifo_2_282a1ee37774475cadffc44729387afc

//TopLevel_282a1ee37774475cadffc44729387afc replaced by TopLevel_282a1ee37774475cadffc44729387afc

module StreamFifo_3_282a1ee37774475cadffc44729387afc (
  input               io_push_valid,
...
module StreamFifo_2_282a1ee37774475cadffc44729387afc (
  input               io_push_valid,
  output              io_push_ready,
...
module TopLevel_282a1ee37774475cadffc44729387afc (
...
//StreamFifo_282a1ee37774475cadffc44729387afc replaced by StreamFifo_282a1ee37774475cadffc44729387afc

module StreamFifo_282a1ee37774475cadffc44729387afc (
  input               io_push_valid,
  output              io_push_ready,
...
module UartCtrl_282a1ee37774475cadffc44729387afc (
  ...
  UartCtrlTx_282a1ee37774475cadffc44729387afc tx (
  ...
  UartCtrlRx_282a1ee37774475cadffc44729387afc rx (
    .io_configFrame_dataLength  (io_config_frame_dataLength[2:0]), //i
    .io_configFrame_stop        (io_config_frame_stop           ), //i
    .io_configFrame_parity      (io_config_frame_parity[1:0]    ), //i
    .io_samplingTick            (clockDivider_tickReg           ), //i
...
module StreamArbiter_282a1ee37774475cadffc44729387afc (
...
module FlowCCByToggle_282a1ee37774475cadffc44729387afc (
  ...
  BufferCC_1_282a1ee37774475cadffc44729387afc inputArea_target_buffercc (
...
module StreamFifoLowLatency_282a1ee37774475cadffc44729387afc (
  input               io_push_valid,
  output              io_push_ready,
...
//BufferCC_2_282a1ee37774475cadffc44729387afc replaced by BufferCC_2_282a1ee37774475cadffc44729387afc

//BufferCC_2_282a1ee37774475cadffc44729387afc replaced by BufferCC_2_282a1ee37774475cadffc44729387afc

//BufferCC_2_282a1ee37774475cadffc44729387afc replaced by BufferCC_2_282a1ee37774475cadffc44729387afc

module BufferCC_2_282a1ee37774475cadffc44729387afc (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               systemCd_logic_outputReset
...
module UartCtrlRx_282a1ee37774475cadffc44729387afc (
  ...
  BufferCC_282a1ee37774475cadffc44729387afc io_rxd_buffercc (
    .io_dataIn                  (io_rxd                    ), //i
...
module UartCtrlTx_282a1ee37774475cadffc44729387afc (
  input      [2:0]    io_configFrame_dataLength,
  input      [0:0]    io_configFrame_stop,
  input      [1:0]    io_configFrame_parity,
  input               io_samplingTick,
...
module BufferCC_1_282a1ee37774475cadffc44729387afc (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               debugCd_logic_outputReset
...
module BufferCC_282a1ee37774475cadffc44729387afc (
  input               io_dataIn,
  output              io_dataOut,
  input               io_systemClk,
  input               systemCd_logic_outputReset
